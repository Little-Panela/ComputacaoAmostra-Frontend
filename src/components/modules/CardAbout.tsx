...
export function CardAbout({children, icon}: CardAboutProps) {
    return(
        <div className={`flex items-center w-[240px] h-[292px] flex-col bg-black/[0.7] rounded-[20px]
                    ...
                    <div className='md:w-[80%] h-full md:text-left text-center box-border pt-[20px] md:pt-0 md:pl-9 pl-[10px] pr-[10px]'>
