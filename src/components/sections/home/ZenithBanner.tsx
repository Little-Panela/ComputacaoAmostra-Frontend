...
=======
    <section className="relative overflow-hidden bg-pallete-background-zen flex flex-col items-center gap-20 pt-24 pb-32 lg:flex-row-reverse lg:justify-center lg:px-20 xl:px-40">
>>>>>>> 8b9d796f3cc43fe835607076446f5f3dc7b769b7
      ...
      <img src="/static/img/zenith-light.png" alt="Zenith Light" className="z-0 absolute -bottom-64 -left-64 xl:w-[900px]" />
      ...
      <div className="flex flex-col items-center gap-20 z-10 lg:gap-10 lg:items-start">
        ...
        <div className="flex flex-col gap-5 w-fit items-center lg:flex-row">
          <Link href="https://zenithinova.com.br" target="_blank" className="flex focus-within:outline-pallete-primary focus:outline-pallete-primary hover:bg-pallete-dark-purple-zen transition-colors justify-center items-center text-bold text-sm px-7 py-3 bg-pallete-purple-zen rounded-3xl">
            {t("home.zenith.button")}
          </Link>
          <div className="flex gap-7 lg:gap-5">
            <Link href="http://instagram.com/_u/zenith.inova/">
              <AiOutlineInstagram size={42} fill="#7327BB" className="transition-colors hover:fill-pallete-dark-purple-zen" />
            </Link>
            <Link href="https://wa.me/5591989661300?text=Olá,%20gostaria%20de%20conversar%20sobre%20os%20projetos%20da%20Zenith%20Inova%20!!!">
              <AiOutlineWhatsApp size={42} fill="#7327BB" className="transition-colors hover:fill-pallete-dark-purple-zen" />
            </Link>
          </div>
        </div>
      </div>
