...
export function Winners() {
  ...
  return (
    <section className="relative py-20 bg-winner-linear lg:bg-winner-linear-md bg-no-repeat bg-cover flex flex-col items-center z-10 mx-auto px-2 pb-20 sm:px-6 lg:px-8 2xl:px-20">
