...
export function Program () {
    ...
    return (
        ...
        <div id="program" className="flex relative overflow-hidden flex-col lg:grid lg:grid-cols-program lg:grid-rows-2 items-center px-8 lg:px-12 xl:px-36 xl:relative md:px-24 py-16 gap-14 lg:gap-0 xl:gap-y-8 lg:gap-x-12 xl:gap-x-24">
            ...
            <img src={'static/img/coconutstree.png'} className=" absolute w-[121px] h-[590px] mix-blend-lighten left-[0px] bottom-[0px] z-[2]" />
            ...
            <div className="flex relative justify-center w-full lg:row-span-2">
                <img src="/static/img/program-tropical-island.svg" className="mb-10 w-auto h-80 md:mb-0 xl:w-[500px] lg:z-[1]" alt="Tropical Island" />
            ...
            <div className="relative z-10 flex flex-col sm:flex-row gap-10 mb-8">
